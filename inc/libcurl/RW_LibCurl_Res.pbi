...
;{ Structures }
  Structure Curl_HTTPPost
    ...
    *name             ; Ptr to allocated name 
    namelength.l        ; Length of name length 
    *contents         ; Ptr to allocated data contents 
    contentslength.l    ; Length of contents field 
    *buffer           ; Ptr to allocated buffer contents 
  ...
  Structure curl_version_info_data
    ...
    *libz_version     ; human readable string 
    ...
    *libidn
    ...
    iconv_ver_num.l
    *libssh_version   ; human readable string 
  EndStructure
;}
