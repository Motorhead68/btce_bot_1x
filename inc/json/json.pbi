...
; ---------------------------------------------
;  test code (uncommend to see result)
; ---------------------------------------------
; 
; Define strTest.s = ""
; strTest + "{"
...
;     strTest + Chr(34) + "Geschlecht" + Chr(34) + ": " + Chr(34) + "mannlich" + Chr(34) + "," 
...
;   strTest + Chr(34) + "Wahrung" + Chr(34) + "     : " + Chr(34) + "EURO" + Chr(34) + ", " 
;   strTest + Chr(34) + "Abzuge" + Chr(34) + "      : [], "
